...
joylink_dev_set_connect_st(int st)
{
	...
	*/
    ...
    ESP_LOGI("\n\n\n\njoylink_dev_set_connect_st", "Available heap size is %d\n", esp_get_free_heap_size());
    ESP_LOGI("joylink_dev_set_connect_st", "Minimum free heap ever available is %d\n\n\n\n", esp_get_minimum_free_heap_size());
	// Save the state.
...
{
    static int power_last = 0;
    static int ambientLight_last = 0;
